...
export const BoxCard = styled(Box)(({ theme, isMobile }) => ({
    padding: theme.spacing(2, 1),
    position: 'absolute',
    top: '70%',
    right: isMobile ? '40%' : '55%',
...
export const ImgBox = styled(`img`)(({ theme, isMobile }) => ({
    padding: isMobile ? theme.spacing(2.5) : theme.spacing(4),
    height: '500px',
...
export const RightContainer = styled(Box)(({ theme, isMobile }) => ({
    padding: theme.spacing(1),
